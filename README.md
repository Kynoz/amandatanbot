...
```
(CMD)
git clone https://github.com/Kynoz/amandatanbot
git init
git add .
git commit -m "OK"
...
[![Heroku Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Kynoz/amandatanbot)
